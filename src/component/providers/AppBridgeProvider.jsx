...
//     const host =
//       new URLSearchParams(location).get("host") ||
//       window.__SHOPIFY_DEV_HOST || 'west-eu-1';
...
//     console.log(process.env.REACT_APP_SHOPIFY_API_KEY, appBridgeConfig.host);
//     const bannerProps = !process.env.REACT_APP_SHOPIFY_API_KEY
//       ? {
//           title: "Missing Shopify API Key",
//           children: (
//             <>
//               Your app is running without the REACT_APP_SHOPIFY_API_KEY environment
