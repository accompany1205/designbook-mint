        ...
        <Container>
          ...
          <SidebarContainer>
            ...
            <SlickBar clicked={click}>
              <Logo>
                <h2 onClick={() => hanldeItemClick()}>{!click ? "D" : "Designbook"}</h2>
              </Logo>
              <Item
              ...
              <Item
                onClick={() => hanldeItemClick("/create-nft")}
                // activeClassName="active"
                to="/create-nft"
              >
                ...
                <Text clicked={click}>Create NFT</Text>
              </Item>
              <Item
                onClick={() => hanldeItemClick("/manage-nfts")}
                // activeClassName="active"
                to="/manage-nfts"
              >
                ...
                <Text clicked={click}>Manage Your NFTs</Text>
              </Item>
              <Item
                onClick={() => hanldeItemClick("/import-nft")}
                // activeClassName="active"
                to="/projects"
              >
                ...
                <Text clicked={click}>Import NFTs</Text>
              </Item>
              <Item
                onClick={() => hanldeItemClick("/contact-us")}
                // activeClassName="active"
                to="/contact-us"
              >
